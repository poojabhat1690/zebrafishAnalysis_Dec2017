...
BOut="/clustertmp/bioinfo/pooja/SLAMannotation/dr_backgroundSamples/output/"
...
find *bam | parallel 'bedtools multicov -split -p -bams {} -bed /clustertmp/bioinfo/pooja/SLAMannotation/dr_backgroundSamples/output//ExtendingINtergenicRegions/customAnnotation_longestTranscripts_100IntoUTR.bed > /clustertmp/bioinfo/pooja/SLAMannotation/dr_backgroundSamples/output//parallel/{}.txt'
...
paste /clustertmp/bioinfo/pooja/SLAMannotation/dr_backgroundSamples/output/ExtendingINtergenicRegions/customAnnotation_longestTranscripts_100IntoUTR.bed mean_counts.txt > customAnnotationWithMean.txt
...
#  awk 'FNR == 5 {print $1}' thresholds.txt
  ...
  endTMP=`awk -v i="$i" -v j=2 'FNR == i {print $j}' thresholds.txt`
   ...
   find *bam | parallel 'bedtools multicov -split -p -bams {} -bed /clustertmp/bioinfo/pooja/SLAMannotation/dr_backgroundSamples/output/parallel/customAnnotationWithMean_10.bed > /clustertmp/bioinfo/pooja/SLAMannotation/dr_backgroundSamples/output/parallel/{}_params.txt' 
