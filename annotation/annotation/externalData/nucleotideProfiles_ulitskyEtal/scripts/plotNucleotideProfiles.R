...
source(paste0("/Volumes/groups/ameres/Pooja/Projects/zebrafishAnnotation/zebrafish_analysis/scripts_ZebrafishData/pipeline/", "/OverlappingPrimingSitesWithAnnotations/overlappingHierarchical.R"))

###reading in the annotations
#FIXME no absolute dirs
utrAnnotation = read.table(paste0("/Volumes/groups/ameres/Pooja/Projects/zebrafishAnnotation/dr10/refSeq_dr10_GRCh38_20170504/", "/processed/refSeq_mrna_utrsPresent.bed"),sep="\t",stringsAsFactors = F)
ensembl_annotation = read.table(paste0("/Volumes/groups/ameres/Pooja/Projects/zebrafishAnnotation/dr10/ensembl_dr10_Ensembl_Genes_88/", "/proteinCoding_annotatedUTRs.bed"),sep="\t",stringsAsFactors = F)
exonAnnotation = read.table(paste0("/Volumes/groups/ameres/Pooja/Projects/zebrafishAnnotation/dr10/refSeq_dr10_GRCh38_20170504/", "/processed/refSeq_exonAnnotations.bed"),sep="\t",stringsAsFactors = F)
intronAnnotation = read.table(paste0("/Volumes/groups/ameres/Pooja/Projects/zebrafishAnnotation/dr10/refSeq_dr10_GRCh38_20170504/", "/processed/refSeq_intronAnnotations.bed"),sep="\t",stringsAsFactors = F)
...
peaks_bedFile = read.table(paste0("/Volumes/groups/ameres/Pooja/Projects/zebrafishAnnotation/sequencingRun_december2017/analysis/annotation/externalData/nucleotideProfiles_ulitskyEtal/data/", "/sequences_120nts.bed"),sep="\t",stringsAsFactors = F)
...
OutPath = "/Volumes/groups/ameres/Pooja/Projects/zebrafishAnnotation/sequencingRun_december2017/analysis/annotation/externalData/nucleotideProfiles_ulitskyEtal/plots/"
...
InPath= "/Volumes/groups/ameres/Pooja/Projects/zebrafishAnnotation/sequencingRun_december2017/analysis/annotation/externalData/nucleotideProfiles_ulitskyEtal/data/"
...
a = plotCululative(totalDivisions)
